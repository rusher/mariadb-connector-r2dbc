...
public class GroupElement implements Serializable {
   ...
   */
  io.r2dbc.mariadb.authentication.ed25519.math.GroupElement[][] precmp;
  /**
   * Precomputed table for {@link
   * #doubleScalarMultiplyVariableTime(io.r2dbc.mariadb.authentication.ed25519.math.GroupElement,
   * byte[], byte[])}, filled if necessary.
   *
   * <p>Variable is package private only so that tests run.
   */
  io.r2dbc.mariadb.authentication.ed25519.math.GroupElement[] dblPrecmp;
   ...
   */
  public static io.r2dbc.mariadb.authentication.ed25519.math.GroupElement p2(
      final Curve curve, final FieldElement X, final FieldElement Y, final FieldElement Z) {
    return new io.r2dbc.mariadb.authentication.ed25519.math.GroupElement(
   ...
   */
  public static io.r2dbc.mariadb.authentication.ed25519.math.GroupElement p3(
      final Curve curve,
      final FieldElement X,
      final FieldElement Y,
      final FieldElement Z,
   ...
   */
  public static io.r2dbc.mariadb.authentication.ed25519.math.GroupElement p1p1(
      final Curve curve,
      final FieldElement X,
      final FieldElement Y,
      final FieldElement Z,
   ...
   */
  public static io.r2dbc.mariadb.authentication.ed25519.math.GroupElement precomp(
   ...
   */
  public static io.r2dbc.mariadb.authentication.ed25519.math.GroupElement cached(
      final Curve curve,
   ...
   */
  public io.r2dbc.mariadb.authentication.ed25519.math.GroupElement toP2() {
   ...
   */
  public io.r2dbc.mariadb.authentication.ed25519.math.GroupElement toP3() {
   ...
   */
  public io.r2dbc.mariadb.authentication.ed25519.math.GroupElement toCached() {
   ...
   */
  private io.r2dbc.mariadb.authentication.ed25519.math.GroupElement toRep(
      final Representation repr) {
    switch (this.repr) {
      case P2:
        switch (repr) {
  ...
  public synchronized void precompute(final boolean precomputeSingle) {
    io.r2dbc.mariadb.authentication.ed25519.math.GroupElement Bi;

    if (precomputeSingle && this.precmp == null) {
      // Precomputation for single scalar multiplication.
      this.precmp = new io.r2dbc.mariadb.authentication.ed25519.math.GroupElement[32][8];
      // TODO-CR BR: check that this == base point when the method is called.
      Bi = this;
      for (int i = 0; i < 32; i++) {
        io.r2dbc.mariadb.authentication.ed25519.math.GroupElement Bij = Bi;
        for (int j = 0; j < 8; j++) {
    ...
    this.dblPrecmp = new io.r2dbc.mariadb.authentication.ed25519.math.GroupElement[8];
    Bi = this;
    for (int i = 0; i < 8; i++) {
   ...
   */
  public io.r2dbc.mariadb.authentication.ed25519.math.GroupElement dbl() {
    switch (this.repr) {
      case P2:
   ...
   */
  private io.r2dbc.mariadb.authentication.ed25519.math.GroupElement madd(
      io.r2dbc.mariadb.authentication.ed25519.math.GroupElement q) {
   ...
   * @return the P1P1 representation of the result.
   */
  private io.r2dbc.mariadb.authentication.ed25519.math.GroupElement msub(
      io.r2dbc.mariadb.authentication.ed25519.math.GroupElement q) {
    if (this.repr != Representation.P3) {
      throw new UnsupportedOperationException();
    }
   ...
   * @return the P1P1 representation of the result.
   */
  public io.r2dbc.mariadb.authentication.ed25519.math.GroupElement add(
      io.r2dbc.mariadb.authentication.ed25519.math.GroupElement q) {
    if (this.repr != Representation.P3) {
      throw new UnsupportedOperationException();
    }
   ...
   * @return the P1P1 representation of the result.
   */
  public io.r2dbc.mariadb.authentication.ed25519.math.GroupElement sub(
      io.r2dbc.mariadb.authentication.ed25519.math.GroupElement q) {
    if (this.repr != Representation.P3) {
      throw new UnsupportedOperationException();
    }
   ...
   */
  public io.r2dbc.mariadb.authentication.ed25519.math.GroupElement negate() {
    if (this.repr != Representation.P3) {
      throw new UnsupportedOperationException();
    }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof io.r2dbc.mariadb.authentication.ed25519.math.GroupElement)) {
      return false;
    }
    io.r2dbc.mariadb.authentication.ed25519.math.GroupElement ge =
        (io.r2dbc.mariadb.authentication.ed25519.math.GroupElement) obj;
   ...
   */
  io.r2dbc.mariadb.authentication.ed25519.math.GroupElement cmov(
      final io.r2dbc.mariadb.authentication.ed25519.math.GroupElement u, final int b) {
   ...
   */
  io.r2dbc.mariadb.authentication.ed25519.math.GroupElement select(final int pos, final int b) {
    // Is r_i negative?
    ...
    // 16^i |r_i| B
    final io.r2dbc.mariadb.authentication.ed25519.math.GroupElement t =
        this.curve
    ...
    // -16^i |r_i| B
    final io.r2dbc.mariadb.authentication.ed25519.math.GroupElement tminus =
   ...
   * @return the GroupElement
   */
  public io.r2dbc.mariadb.authentication.ed25519.math.GroupElement scalarMultiply(final byte[] a) {
    io.r2dbc.mariadb.authentication.ed25519.math.GroupElement t;
    int i;

    final byte[] e = toRadix16(a);

    io.r2dbc.mariadb.authentication.ed25519.math.GroupElement h =
   ...
   * @return the GroupElement
   */
  public io.r2dbc.mariadb.authentication.ed25519.math.GroupElement doubleScalarMultiplyVariableTime(
      final io.r2dbc.mariadb.authentication.ed25519.math.GroupElement A,
      final byte[] a,
      final byte[] b) {
    ...
    io.r2dbc.mariadb.authentication.ed25519.math.GroupElement r =
    ...
    synchronized (this) {
      ...
      // precompute();
      for (; i >= 0; --i) {
        io.r2dbc.mariadb.authentication.ed25519.math.GroupElement t = r.dbl();
