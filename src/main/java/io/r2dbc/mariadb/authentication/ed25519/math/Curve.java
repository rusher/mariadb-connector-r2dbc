...
public class Curve implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof io.r2dbc.mariadb.authentication.ed25519.math.Curve)) {
      return false;
    }
    io.r2dbc.mariadb.authentication.ed25519.math.Curve c =
        (io.r2dbc.mariadb.authentication.ed25519.math.Curve) o;
