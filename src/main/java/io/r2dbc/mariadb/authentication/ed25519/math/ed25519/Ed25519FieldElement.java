 ...
 */
package io.r2dbc.mariadb.authentication.ed25519.math.ed25519;

import io.r2dbc.mariadb.authentication.ed25519.Utils;
import io.r2dbc.mariadb.authentication.ed25519.math.Field;
import io.r2dbc.mariadb.authentication.ed25519.math.FieldElement;
...
public class Ed25519FieldElement extends FieldElement {
  ...
  public FieldElement add(FieldElement val) {
    int[] g = ((io.r2dbc.mariadb.authentication.ed25519.math.ed25519.Ed25519FieldElement) val).t;
    int[] h = new int[10];
    for (int i = 0; i < 10; i++) {
      h[i] = t[i] + g[i];
    }
    return new io.r2dbc.mariadb.authentication.ed25519.math.ed25519.Ed25519FieldElement(f, h);
  }
  ...
  public FieldElement cmov(FieldElement val, int b) {
    io.r2dbc.mariadb.authentication.ed25519.math.ed25519.Ed25519FieldElement that =
        (io.r2dbc.mariadb.authentication.ed25519.math.ed25519.Ed25519FieldElement) val;
    b = -b;
    ...
    return new io.r2dbc.mariadb.authentication.ed25519.math.ed25519.Ed25519FieldElement(
        this.f, result);
  }
  ...
  public boolean equals(Object obj) {
    if (!(obj
        instanceof io.r2dbc.mariadb.authentication.ed25519.math.ed25519.Ed25519FieldElement)) {
      return false;
    }
    io.r2dbc.mariadb.authentication.ed25519.math.ed25519.Ed25519FieldElement fe =
        (io.r2dbc.mariadb.authentication.ed25519.math.ed25519.Ed25519FieldElement) obj;
