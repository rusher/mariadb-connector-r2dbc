...
public class EdDSAParameterSpec implements AlgorithmParameterSpec, Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof io.r2dbc.mariadb.authentication.ed25519.spec.EdDSAParameterSpec)) {
      return false;
    }
    io.r2dbc.mariadb.authentication.ed25519.spec.EdDSAParameterSpec s =
        (io.r2dbc.mariadb.authentication.ed25519.spec.EdDSAParameterSpec) o;
